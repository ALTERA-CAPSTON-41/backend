...
// SearchDataByNameParam provides a mock function with given fields: name
func (_m *Repositories) SearchDataByNameParam(name string) ([]patient.Domain, error) {
	ret := _m.Called(name)
...
func (_m *Repositories) SelectAllData() ([]patient.Domain, error) {
	ret := _m.Called()
